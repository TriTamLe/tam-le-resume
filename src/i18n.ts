...
const messages = {
  en: {
    hero: {
      ...
      body: "Clean starter layout without default Vite placeholders. Tailwind v4 + DaisyUI are ready for your resume/portfolio.",
      primary: "View Resume",
      secondary: "Contact",
    },
    summary: {
  ...
  vi: {
    hero: {
      ...
      body: "Bố cục khởi đầu sạch, đã bỏ placeholder mặc định Vite. Tailwind v4 + DaisyUI sẵn sàng cho CV/portfolio.",
      primary: "Xem CV",
      secondary: "Liên hệ",
    },
    summary: {
